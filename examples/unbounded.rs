...
use piston_window::*;
fn main() {
    let mut window: PistonWindow = WindowSettings::new("Unbounded", (WINDOW_WIDTH, WINDOW_HEIGHT))
        .exit_on_esc(true)
        .build()
    ...
    let mut left = -(640 / PIXELS_PER_CELL as i32) / 2;
    let mut top = (640 / PIXELS_PER_CELL as i32) / 2;
